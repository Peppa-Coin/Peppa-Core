...
This document provides guidelines for internationalization of the Peppacoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `peppacoin_en.ts` remains unchanged.
