Peppacoin Core version 0.9.4 is now available from:

  https://peppacoin.org/bin/0.9.4/
...
this update is incompatible with the Peppacoin system and could lead to consensus
forks.

Peppacoin Core released binaries from https://peppacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~peppacoin/+archive/ubuntu/peppacoin
- A third-party or self-compiled Peppacoin Core

upgrade to Peppacoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
