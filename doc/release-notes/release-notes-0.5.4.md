Peppacoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/peppacoin/files/Peppacoin/peppacoin-0.5.4/
...
http://gitorious.org/peppacoin/peppacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Peppacoin-Qt notifications under Growl 1.3.
Increase required age of Peppacoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPeppacoin properly when installing Peppacoin-Qt over it. (Windows)
