...
Peppacoin Core version 0.19.1 is now available from:

  <https://peppacoincore.org/bin/peppacoin-core-0.19.1/>
...
From Peppacoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Peppacoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Peppacoin Core does not yet change appearance when
...
- #17488 fix "peppacoind already running" warnings on macOS (fanquake)
