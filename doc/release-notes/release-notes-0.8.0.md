Peppacoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/peppacoin/files/Peppacoin/peppacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Peppacoin
...
New/changed settings (command-line or peppacoin.conf file)
--------------------------------------------------------
