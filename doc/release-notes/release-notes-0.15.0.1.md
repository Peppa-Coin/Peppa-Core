Peppacoin Core version *0.15.0.1* is now available from:

  <https://peppacoin.org/bin/peppacoin-core-0.15.0.1/>

and

  <https://peppacoincore.org/bin/peppacoin-core-0.15.0.1/>
