Peppacoin Core version *0.15.2* is now available from:

  <https://peppacoincore.org/bin/peppacoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in peppacoin-tx (TheBlueMatt)
