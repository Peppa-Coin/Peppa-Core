Peppacoin Core version 0.16.1 is now available from:

  <https://peppacoincore.org/bin/peppacoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting peppacoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure peppacoind processes are cleaned up when tests end (sdaftuar)
