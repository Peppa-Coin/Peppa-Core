Peppacoin Core version 0.10.4 is now available from:

  <https://peppacoin.org/bin/peppacoin-core-0.10.4/>
...
- #6953 `43c2789` Split peppacoin-tx into its own package
- #6953 `dfe0d4d` Include peppacoin-tx binary on Debian/Ubuntu
