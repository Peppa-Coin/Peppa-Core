Peppacoin Core version 0.13.2 is now available from:

  <https://peppacoin.org/bin/peppacoin-core-0.13.2/>
...
- #8908 `4a974b2` Update peppacoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow peppacoin-tx to create v2 transactions (btcdrak)
