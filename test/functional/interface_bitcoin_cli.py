...
class TestPeppacoinCli(PeppacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `peppacoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and peppacoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and peppacoin-cli getwalletinfo return expected wallet info")
            ...
            # Test peppacoin-cli -generate with -rpcwallet in multiwallet mode.
