...
class TestShell:
    """Wrapper Class for PeppacoinTestFramework.

    The TestShell class extends the PeppacoinTestFramework
    ...
    class __TestShell(PeppacoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PeppacoinTestFramework child class.
            self.num_nodes = 1
