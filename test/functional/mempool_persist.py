...
By default, peppacoind will dump mempool on shutdown and
...
class MempoolPersistTest(PeppacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent peppacoind from writing mempool.dat to disk. Verify that `savemempool` fails")
