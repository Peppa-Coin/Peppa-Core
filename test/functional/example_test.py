...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PeppacoinTestFramework
    pass


class ExampleTest(PeppacoinTestFramework):
    # Each functional test is a subclass of the PeppacoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PeppacoinTestFramework class so other tests can use it."""
