...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/peppacoin/peppacoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(PeppacoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our peppacoind node")
