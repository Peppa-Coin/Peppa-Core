...
"""
Test starting peppacoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(PeppacoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that peppacoind has bound on "::1" (for RPC) and "::" (for P2P).
