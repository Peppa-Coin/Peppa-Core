...
Verify that a peppacoind node can use an external signer command.
...
class RPCSignerTest(PeppacoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart peppacoind with -signer=<cmd>',
