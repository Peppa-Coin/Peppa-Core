...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/peppacoin/peppacoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(PeppacoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/peppacoin/peppacoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
