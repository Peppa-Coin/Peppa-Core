...
"""Example logging Peppacoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/peppacoind
...
def main(peppacoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[peppacoind_with_usdts])
