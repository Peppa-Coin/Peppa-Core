...
# Extract options
function __fish_peppacoin_tx_get_options
...
# Extract commands
function __fish_peppacoin_tx_get_commands
...
# Add options
complete \
    --command peppacoin-tx \
    --condition "not __fish_peppacoin_seen_cmd (__fish_peppacoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_peppacoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command peppacoin-tx \
    --arguments "(__fish_peppacoin_tx_get_commands)" \
    --no-files
