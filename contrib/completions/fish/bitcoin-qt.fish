...
complete --command peppacoin-qt --no-files

# Extract options
function __fish_peppacoinqt_get_options
...
complete \
    --command peppacoin-qt \
    --arguments "(__fish_peppacoinqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c peppacoin-qt \
...
complete \
    --command peppacoin-qt \
    --arguments "(__fish_peppacoinqt_get_options --nofiles)"
