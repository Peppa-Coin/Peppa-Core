...
complete --command peppacoind --no-files

# Extract options
function __fish_peppacoind_get_options
...
complete \
    --command peppacoind \
    --arguments "(__fish_peppacoind_get_options --nofiles)"
