...
"""Script for verifying Peppacoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
peppacoincore.org and peppacoin.org and compares them.
...
WORKINGDIR = "/tmp/peppacoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://peppacoincore.org"
HOST2 = "https://peppacoin.org"
VERSIONPREFIX = "peppacoin-core-"
...
def main(args):
    ...
    if not success:
        print("peppacoin.org failed to provide signature file, "
              "but peppacoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("peppacoin.org and peppacoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Peppacoin Core binary release "
