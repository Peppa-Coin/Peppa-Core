...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef PEPPACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define PEPPACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the peppacoin network\n')
    ...
    g.write('#endif // PEPPACOIN_CHAINPARAMSSEEDS_H\n')
