...
#ifndef PEPPACOIN_INTERFACES_INIT_H
#define PEPPACOIN_INTERFACES_INIT_H
...
//! (peppacoin-gui, peppacoin-node, peppacoin-wallet, peppacoind, peppacoin-qt) and each
...
#endif // PEPPACOIN_INTERFACES_INIT_H
