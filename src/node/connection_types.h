...
#ifndef PEPPACOIN_NODE_CONNECTION_TYPES_H
#define PEPPACOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/peppacoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Peppacoin’s Peer-to-Peer Network")
...
#endif // PEPPACOIN_NODE_CONNECTION_TYPES_H
