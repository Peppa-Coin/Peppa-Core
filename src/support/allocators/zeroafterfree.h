...
#ifndef PEPPACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define PEPPACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // PEPPACOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
