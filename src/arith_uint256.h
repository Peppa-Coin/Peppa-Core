...
#ifndef PEPPACOIN_ARITH_UINT256_H
#define PEPPACOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Peppacoin only uses this "compact" format for encoding difficulty
...
#endif // PEPPACOIN_ARITH_UINT256_H
