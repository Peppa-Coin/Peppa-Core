...
#ifndef PEPPACOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define PEPPACOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@peppacoin.
 *
 ...
 *
 * The chacha20-poly1305@peppacoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@peppacoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@peppacoin are relatively fast in
...
#endif // PEPPACOIN_CRYPTO_CHACHA_POLY_AEAD_H
