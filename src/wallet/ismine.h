...
#ifndef PEPPACOIN_WALLET_ISMINE_H
#define PEPPACOIN_WALLET_ISMINE_H
 ...
 * https://github.com/peppacoin/peppacoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // PEPPACOIN_WALLET_ISMINE_H
