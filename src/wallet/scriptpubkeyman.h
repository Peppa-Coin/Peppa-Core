...
#ifndef PEPPACOIN_WALLET_SCRIPTPUBKEYMAN_H
#define PEPPACOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Peppacoin Core wallet was originally a collection of unrelated private
...
#endif // PEPPACOIN_WALLET_SCRIPTPUBKEYMAN_H
