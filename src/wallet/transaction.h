...
#ifndef PEPPACOIN_WALLET_TRANSACTION_H
#define PEPPACOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this peppacoin node, and set to 0 for transactions that were created
...
#endif // PEPPACOIN_WALLET_TRANSACTION_H
