...
#ifndef PEPPACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define PEPPACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // PEPPACOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
