...
#ifndef PEPPACOIN_WALLET_WALLETUTIL_H
#define PEPPACOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! peppacoin from opening the wallet, thinking it was newly created, and
...
#endif // PEPPACOIN_WALLET_WALLETUTIL_H
