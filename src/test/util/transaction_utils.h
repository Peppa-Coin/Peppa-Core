// Copyright (c) 2019-2020 The Peppacoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef PEPPACOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define PEPPACOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // PEPPACOIN_TEST_UTIL_TRANSACTION_UTILS_H
