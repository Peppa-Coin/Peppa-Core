...
#ifndef PEPPACOIN_TEST_SCRIPTNUM10_H
#define PEPPACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Peppacoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PEPPACOIN_TEST_SCRIPTNUM10_H
