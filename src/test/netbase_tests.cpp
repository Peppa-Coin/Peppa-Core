// Copyright (c) 2012-2022 The Peppacoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.peppacoincore.org", "www.peppacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.peppacoincore.org]", "www.peppacoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.peppacoincore.org:80", "www.peppacoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.peppacoincore.org]:80", "www.peppacoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.peppacoincore.org:65536", "www.peppacoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.peppacoincore.org:0", "www.peppacoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.peppacoincore.org:", "www.peppacoincore.org:", 0, false));
}
