...
#ifndef PEPPACOIN_KERNEL_CONTEXT_H
#define PEPPACOIN_KERNEL_CONTEXT_H

#include <memory>

namespace kernel {
//! Context struct holding the kernel library's logically global state, and
//! passed to external libpeppacoin_kernel functions which need access to this
...
#endif // PEPPACOIN_KERNEL_CONTEXT_H
