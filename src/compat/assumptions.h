...
#ifndef PEPPACOIN_COMPAT_ASSUMPTIONS_H
#define PEPPACOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Peppacoin cannot be compiled without assertions."
#endif
...
#endif // PEPPACOIN_COMPAT_ASSUMPTIONS_H
