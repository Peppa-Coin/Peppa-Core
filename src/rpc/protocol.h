...
#ifndef PEPPACOIN_RPC_PROTOCOL_H
#define PEPPACOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in peppacoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Peppacoin is not connected
...
#endif // PEPPACOIN_RPC_PROTOCOL_H
