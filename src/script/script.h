...
#ifndef PEPPACOIN_SCRIPT_SCRIPT_H
#define PEPPACOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Peppacoin always counted CHECKMULTISIGs
...
#endif // PEPPACOIN_SCRIPT_SCRIPT_H
