...
#ifndef PEPPACOIN_SCRIPT_STANDARD_H
#define PEPPACOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a peppacoin address
 */
...
/**
 * Generate a Peppacoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PEPPACOIN_SCRIPT_STANDARD_H
