...
#ifndef PEPPACOIN_UTIL_MESSAGE_H
#define PEPPACOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's peppacoin address, it must refer to a public key.
...
#endif // PEPPACOIN_UTIL_MESSAGE_H
