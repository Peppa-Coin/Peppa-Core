...
#ifndef PEPPACOIN_UTIL_SYSCALL_SANDBOX_H
#define PEPPACOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during peppacoind initialization if Peppacoin Core was compiled
...
#endif // PEPPACOIN_UTIL_SYSCALL_SANDBOX_H
