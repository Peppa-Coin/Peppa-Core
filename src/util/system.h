 ...
 */
#ifndef PEPPACOIN_UTIL_SYSTEM_H
#define PEPPACOIN_UTIL_SYSTEM_H
...
extern const char * const PEPPACOIN_CONF_FILENAME;
extern const char * const PEPPACOIN_SETTINGS_FILENAME;
