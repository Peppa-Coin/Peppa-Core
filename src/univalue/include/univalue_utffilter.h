...
#ifndef PEPPACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define PEPPACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // PEPPACOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
