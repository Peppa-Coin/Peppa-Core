...
// Copyright 2015 Peppacoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef PEPPACOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define PEPPACOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // PEPPACOIN_UNIVALUE_INCLUDE_UNIVALUE_H
