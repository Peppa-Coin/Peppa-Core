...
//! Entry point for PeppacoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PeppacoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PeppacoinGUI tests.
void AppTests::guiTests(PeppacoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PeppacoinGUI::consoleShown, this, &AppTests::consoleTests);
