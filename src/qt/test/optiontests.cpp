...
{
    // Test regression https://github.com/peppacoin/peppacoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/peppacoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/peppacoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Peppacoin/Peppacoin-Qt.conf and all else left as default,
    // peppacoin-qt should set both -listen and -listenonion to false and start successfully.
