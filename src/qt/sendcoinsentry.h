...
#ifndef PEPPACOIN_QT_SENDCOINSENTRY_H
#define PEPPACOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending peppacoins.
 */
...
#endif // PEPPACOIN_QT_SENDCOINSENTRY_H
