      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->peppacoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->peppacoinAtStartup);
    ...
    ui->peppacoinAtStartup->setToolTip(ui->peppacoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->peppacoinAtStartup->setText(ui->peppacoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openPeppacoinConfButton->setToolTip(ui->openPeppacoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new PeppacoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->peppacoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPeppacoinConfButton_clicked()
{
